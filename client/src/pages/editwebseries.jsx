...
export const EditWebSeries = () => {
    ...
    const update_web_series_data = async () => {
        try {
            const bodyData = {
            ...
            const response = await fetch(`http://localhost:8000/api/admin/webseries/update/${params.id}`, {
                method: "PATCH",
                headers: {
            ...
            navigate("/admin/seeallwebseries");
        } catch (error) {
    ...
    const getwebseriesdetail = async () => {
        try {
            const response = await fetch(`http://localhost:8000/api/admin/webseries/${params.id}`, {
                method: "GET",
                headers: {
                    Authorization: authorization_token
                },
            ...
            if (response.ok) {
                ...
                console.log(data);
                setWebSeries({
                    webSeriesName: data.webSeriesName,
                    WebSeriesImageURL: data.WebSeriesImageURL,
                    description: data.description,
                    tags: data.tags,
                    ageLimit: data.ageLimit,
                    isPremiumWebSeries: data.isPremiumWebSeries,
                    rating: data.rating,
